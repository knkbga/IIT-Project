...
public class AuditoryOnlyPage extends AppCompatActivity {
    private int level = 6 ;
    private String questionString  ;
    //private Random distraction = new Random() ;
    private static MediaPlayer audio ;
    private static int back_button_pressed ;
    private int distraction_int = 0 ; // No distraction

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_auditory_only_page);
        myGameLoop(level) ;
    }
    ...
    public void onBackPressed()
    {
        ...
        Intent intent = new Intent(AuditoryOnlyPage.this, MainActivity.class);
