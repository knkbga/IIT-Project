...
public class Test2 extends AppCompatActivity {
    ...
    public void myGameLoop(int level)
    {
        ...
        for(i = 0;i<lenth;i++)
        {
            ...
            if (distraction_int==1)
            {
                ...
                Random distraction_random_number = new Random() ;
                int distraction_number = distraction_random_number.nextInt(10) ;
    ...
    public void visualOnlySubmitButton() throws InterruptedException {
        ...
        else if ((questionString.equals(answerString))&&(lenth == 14))
        {
            ...
            {
                startActivity(new Intent(comprehensive.Test2.this,comprehensive.TrialsWDistraction.class));
            }
        }
        else
        {
            ...
            else
            {
                ...
                Thread.sleep(1500);
                lives_left = 3;
                Intent myIntent = new Intent(comprehensive.Test2.this,HomePage.class);
